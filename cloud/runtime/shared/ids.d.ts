...
export const MAX_RECORD_KEY_BYTES: 768;
...
export function isSafeRecordKey(value: unknown): value is string;
export function normalizeRecordKey(value: unknown): string | null;
