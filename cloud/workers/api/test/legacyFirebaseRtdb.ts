...
import { createGoogleAccessToken } from "../test/legacyGoogleAuth.ts";
...
import {
  ...
  isSafeFirebaseKey,
} from "../src/firebaseKeys.ts";
import { notifyMatchSyncChanged } from "../src/matchSyncNotifications.ts";
import {
...
type LegacyFirebaseEnv = Env &
  FirebaseRtdbLocation & {
    GAMEPLAY_SERVICE_ACCOUNT_EMAIL?: string;
    GAMEPLAY_SERVICE_ACCOUNT_PRIVATE_KEY?: string;
  };
