/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: c2ee78bda2055dc6e55f5df389f3bab7)
...
interface __BaseEnv_Env {
	...
	MATCH_STATE_MIGRATION_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_AUDIENCES" | "AUTH_MUTATIONS_DISABLED" | "SESSION_JWT_KEYS" | "MATCH_PRESENTATION_MIGRATION_SECRET" | "MATCH_STATE_MIGRATION_SECRET" | "HELIUS_RPC_API_KEY" | "EVENT_PRIZE_ADMIN_PRIVATE_KEY" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_EXTRA_CHAT_ID" | "TELEGRAM_QUEUE_BRIDGE_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
