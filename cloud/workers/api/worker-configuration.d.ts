/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: 46b4b548ccad49ccf8722307784112fa)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_AUDIENCES" | "AUTH_DISABLE_APPLE_VERIFY" | "AUTH_DISABLE_MERGE" | "AUTH_DISABLE_UNLINK" | "AUTH_DISABLE_X_VERIFY" | "FIREBASE_RTDB_URL" | "SIWE_ALLOWED_DOMAINS" | "FIRESTORE_SERVICE_ACCOUNT_EMAIL" | "FIRESTORE_SERVICE_ACCOUNT_PRIVATE_KEY" | "GAMEPLAY_SERVICE_ACCOUNT_EMAIL" | "GAMEPLAY_SERVICE_ACCOUNT_PRIVATE_KEY" | "HELIUS_RPC_API_KEY" | "RATING_SERVICE_ACCOUNT_EMAIL" | "RATING_SERVICE_ACCOUNT_PRIVATE_KEY" | "TELEGRAM_ANNOUNCEMENT_BRIDGE_SECRET" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_EXTRA_CHAT_ID" | "TELEGRAM_FIREBASE_SERVICE_ACCOUNT_EMAIL" | "TELEGRAM_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY" | "TELEGRAM_QUEUE_BRIDGE_SECRET" | "USERNAME_SERVICE_ACCOUNT_EMAIL" | "USERNAME_SERVICE_ACCOUNT_PRIVATE_KEY" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
