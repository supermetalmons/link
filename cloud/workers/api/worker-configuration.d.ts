/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: c180bae23ee351b848f79089ff63f074)
// Runtime types generated with workerd@1.20260820.1 2026-08-09 nodejs_compat
interface __BaseEnv_Env {
	...
	FIRESTORE_SERVICE_ACCOUNT_EMAIL: string;
	FIRESTORE_SERVICE_ACCOUNT_PRIVATE_KEY: string;
	GAMEPLAY_SERVICE_ACCOUNT_EMAIL: string;
	GAMEPLAY_SERVICE_ACCOUNT_PRIVATE_KEY: string;
	HELIUS_RPC_API_KEY: string;
	RATING_SERVICE_ACCOUNT_EMAIL: string;
	RATING_SERVICE_ACCOUNT_PRIVATE_KEY: string;
	EVENT_PRIZE_ADMIN_PRIVATE_KEY: string;
	TELEGRAM_ANNOUNCEMENT_BRIDGE_SECRET: string;
	TELEGRAM_BOT_TOKEN: string;
	TELEGRAM_EXTRA_CHAT_ID: string;
	TELEGRAM_FIREBASE_SERVICE_ACCOUNT_EMAIL: string;
	TELEGRAM_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY: string;
	TELEGRAM_QUEUE_BRIDGE_SECRET: string;
	USERNAME_SERVICE_ACCOUNT_EMAIL: string;
	USERNAME_SERVICE_ACCOUNT_PRIVATE_KEY: string;
	X_CLIENT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_AUDIENCES" | "AUTH_MUTATIONS_DISABLED" | "FIREBASE_RTDB_URL" | "PROFILE_READ_MODE" | "PROFILE_STORAGE_MODE" | "FIRESTORE_SERVICE_ACCOUNT_EMAIL" | "FIRESTORE_SERVICE_ACCOUNT_PRIVATE_KEY" | "GAMEPLAY_SERVICE_ACCOUNT_EMAIL" | "GAMEPLAY_SERVICE_ACCOUNT_PRIVATE_KEY" | "HELIUS_RPC_API_KEY" | "RATING_SERVICE_ACCOUNT_EMAIL" | "RATING_SERVICE_ACCOUNT_PRIVATE_KEY" | "EVENT_PRIZE_ADMIN_PRIVATE_KEY" | "TELEGRAM_ANNOUNCEMENT_BRIDGE_SECRET" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_EXTRA_CHAT_ID" | "TELEGRAM_FIREBASE_SERVICE_ACCOUNT_EMAIL" | "TELEGRAM_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY" | "TELEGRAM_QUEUE_BRIDGE_SECRET" | "USERNAME_SERVICE_ACCOUNT_EMAIL" | "USERNAME_SERVICE_ACCOUNT_PRIVATE_KEY" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
