/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: a5a39881cb54745c7538b8663e8b6573)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIRESTORE_SERVICE_ACCOUNT_EMAIL" | "FIRESTORE_SERVICE_ACCOUNT_PRIVATE_KEY" | "HELIUS_RPC_API_KEY" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
