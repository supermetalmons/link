/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: bde5dfa61442a900dfdaa6c459af3705)
// Runtime types generated with workerd@1.20260828.1 2026-08-09 nodejs_compat
interface __BaseEnv_Env {
	...
	FIREBASE_IDENTITY_SERVICE_ACCOUNT_EMAIL: string;
	FIREBASE_IDENTITY_SERVICE_ACCOUNT_PRIVATE_KEY: string;
