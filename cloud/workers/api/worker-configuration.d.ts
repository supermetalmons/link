/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: 0a5e33890e50c16a61522820a47bec7e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_DISABLE_X_VERIFY" | "FIREBASE_RTDB_URL" | "FIRESTORE_SERVICE_ACCOUNT_EMAIL" | "FIRESTORE_SERVICE_ACCOUNT_PRIVATE_KEY" | "GAMEPLAY_SERVICE_ACCOUNT_EMAIL" | "GAMEPLAY_SERVICE_ACCOUNT_PRIVATE_KEY" | "HELIUS_RPC_API_KEY" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_EXTRA_CHAT_ID" | "TELEGRAM_FIREBASE_SERVICE_ACCOUNT_EMAIL" | "TELEGRAM_FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY" | "TELEGRAM_QUEUE_BRIDGE_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
