/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: e4fe84e3ddbc45208cb68a02d830d280)
...
interface __BaseEnv_Env {
	...
	D1_MIGRATION_RUN_ID: "";
	EVENT_DB_BOOKMARK_EPOCH: "1638d8f3-2890-4bf2-9b8a-16bb197e2b3b";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_AUDIENCES" | "AUTH_MUTATIONS_DISABLED" | "API_MAINTENANCE" | "D1_MIGRATION_RUN_ID" | "EVENT_DB_BOOKMARK_EPOCH" | "SESSION_JWT_KEYS" | "HELIUS_RPC_API_KEY" | "EVENT_PRIZE_ADMIN_PRIVATE_KEY" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_EXTRA_CHAT_ID" | "TELEGRAM_QUEUE_BRIDGE_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
