/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: e041368ac7bccff0c925b13d965b8b5a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_DISABLE_X_VERIFY" | "FIRESTORE_SERVICE_ACCOUNT_EMAIL" | "FIRESTORE_SERVICE_ACCOUNT_PRIVATE_KEY" | "HELIUS_RPC_API_KEY" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
